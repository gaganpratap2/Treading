...
import com.rana.repository.CoinRepository;
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try{
            ...
            coin.setPriceChangePercentage24h(
                    marketData.get("price_change2_24h").get("usd").asDouble());

            coin.setMarketCapChange24h((double) marketData.get("market_cap_change_24h").asLong());

            coin.setMarketCapChangePercentage24h(marketData.get("market_cap_change_percentage_24h").asDouble());

            coin.setTotalSupply((double) marketData.get("total_supply").get("usd").asLong());
